<?php
/**
 * GitHub Updater for Fleet Plugin
 *
...
if ( class_exists( 'iworks_fleet_github' ) ) {
	return;
}
...
class iworks_fleet_github {
	 ...
	 * @var string
	 */
	private string $repository = 'iworks/fleet';
	 ...
	 * @var string
	 */
	private string $plugin_file = 'fleet.php';
	 ...
	 * @var string
	 */
	private string $plugin_folder = 'fleet';
	...
	public function action_init_load_plugin_textdomain() {
		...
		load_plugin_textdomain( 'fleet', false, $dir );
	}
